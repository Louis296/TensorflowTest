...
def get_name_and_image():
    all_image = os.listdir('E:/Project/TensorflowTest/captcha4/')
    random_file = random.randint(0, 3429)
    base = os.path.basename('E:/Project/TensorflowTest/captcha4/' + all_image[random_file])
    name = os.path.splitext(base)[0]
    image = Image.open('E:/Project/TensorflowTest/captcha4/' + all_image[random_file])
